...
public class MotorController {
    ...
    public ResponseEntity<String> eliminarFurgoneta(@PathVariable int num) {
    ...
    public ResponseEntity<String> eliminarCoche(@PathVariable int num) {
    ...
    public ResponseEntity<String> eliminarMoto(@PathVariable int num) {
...
public ResponseEntity<String> eliminarMantenimiento(@PathVariable int num) {
